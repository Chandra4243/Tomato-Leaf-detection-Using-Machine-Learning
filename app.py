...
filepath = r'C:/Users/Chandrabhushan/.vscode/Project from scratch/Tomato Leaf Disease Detection/model.h5'
...
def pred_tomato_dieas(tomato_plant):
    ...
    if pred == 0:
        ...
        return "Tomato Yellow Leaf Curl Virus Disease", 'Tomato - Tomato_Yellow_Leaf_Curl_Virus.html'

    elif pred == 8:
        return "Tomato Mosaic Virus Disease", 'Tomato - Tomato_mosaic_virus.html'
...
def predict():
    if request.method == 'POST':
        ...
        file_path = os.path.join(
            r'C:\Users\Chandrabhushan\.vscode\Project from scratch\Tomato Leaf Disease Detection\static\upload',
            filename)

        file.save(file_path)  # ✅ THIS LINE IS CRUCIAL
